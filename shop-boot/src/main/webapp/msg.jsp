			...
			<div class="main">
				...
				<div style="text-align: center; padding: 50px;">
					...
					<div style="margin-top: 30px;">
						<a href="<%=basePath %>product/frontlist" style="color: #2c8ac0; text-decoration: none; font-size: 14px;">返回首页</a>
						&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="<%=basePath %>car.jsp" style="color: #2c8ac0; text-decoration: none; font-size: 14px;">查看购物车</a>
					</div>
				</div>
			</div>
		</div>
